...
@Component({
  selector: "cms-app-garage",
  templateUrl: "./garage.component.html",
  styleUrls: ["./garage.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class SysGarageComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  viewRecord = (e) => {
    ...
    window.open("cms/system/garage/" + paramAdd, "_blank");
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-garage", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-garage", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/system/garage/new"]);
        break;
      default:
        break;
    }
  ...
  clickRecord = (data, status) => {
    if (data && status === 'view') {
      ...
      const paramAdd = window.btoa(JSON.stringify(objParamAdd));
      // window.open("/cms/system/garage/" + paramAdd, "_blank");
      this.router.navigate(["/cms/system/garage", paramAdd]);
