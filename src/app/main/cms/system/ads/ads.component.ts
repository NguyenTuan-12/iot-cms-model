...
@Component({
  selector: "cms-app-ads",
  templateUrl: "./ads.component.html",
  styleUrls: ["./ads.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class SysAdsComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  viewRecord = (e) => {
    ...
    window.open("cms/system/ads/" + paramAdd, "_blank");
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-ads", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-ads", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/system/ads/new"]);
        break;
      default:
        break;
    }
  ...
  clickRecord = (data, status) => {
    if (data && status === 'view') {
      ...
      const paramAdd = window.btoa(JSON.stringify(objParamAdd));
      // window.open("/cms/system/ads/" + paramAdd, "_blank");
      this.router.navigate(["/cms/system/ads", paramAdd]);
