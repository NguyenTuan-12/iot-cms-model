...
export class AppCustomerComponent implements OnInit {
  ...
  viewRecord = (e) => {
    ...
    window.open("cms/partner/customer/" + paramAdd, "_blank");
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-customer", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-customer", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/partner/customer/new"]);
        break;
      default:
        break;
    }
  ...
  clickRecord = (data, status) => {
    if (data && status === 'view') {
      ...
      const paramAdd = window.btoa(JSON.stringify(objParamAdd));
      // window.open("/cms/partner/customer/" + paramAdd, "_blank");
      this.router.navigate(["/cms/partner/customer", paramAdd]);
    }
    if (data && status === 'edit') {
      this.modelAdd = data;
