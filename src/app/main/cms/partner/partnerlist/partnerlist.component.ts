...
export class AppPartnerListComponent implements OnInit {
  ...
  viewRecord = (e) => {
    ...
    window.open("cms/partner/partnerlist/" + paramAdd, "_blank");
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-partner", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-partner", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/partner/partnerlist/new"]);
        break;
      default:
        break;
    }
  ...
  clickRecord = (data, status) => {
    if (data && status === 'view') {
      ...
      const paramAdd = window.btoa(JSON.stringify(objParamAdd));
      // window.open("/cms/partner/partnerlist/" + paramAdd, "_blank");
      this.router.navigate(["/cms/partner/partnerlist", paramAdd]);
    }
    if (data && status === 'edit') {
      this.modelAdd = data;
