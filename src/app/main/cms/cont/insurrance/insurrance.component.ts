...
@Component({
  selector: "app-customer-insurrance",
  templateUrl: "./insurrance.component.html",
  styleUrls: ["./insurrance.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class AppCustomerInsurranceComponent implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-adspromotion", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-adspromotion", extraParams);
  }
