...
@Component({
  selector: "app-customer-garange",
  templateUrl: "./garange.component.html",
  styleUrls: ["./garange.component.scss"],
  providers: [FilterService, VirtualScrollService],
  encapsulation: ViewEncapsulation.None,
})
export class AppCustomerGarange implements OnInit {
  // Varriable Language
  languages: any;
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-contact", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-contact", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/system/contact/new"]);
        break;
      default:
        break;
    }
