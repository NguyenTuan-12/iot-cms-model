...
export class ProductListComponent implements OnInit {
  ...
  viewRecord = (e) => {
    ...
    window.open("/cms/productservice/productlist/" + paramAdd, "_blank");
  };
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-product", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-product", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/productservice/productlist/new"]);
        break;
      default:
        break;
    }
  ...
  clickRecord = (data, status) => {
    if (data && status === 'view') {
      ...
      const paramAdd = window.btoa(JSON.stringify(objParamAdd));
      // window.open("/cms/productservice/productlist/" + paramAdd, "_blank");
      this.router.navigate(["/cms/productservice/productlist", paramAdd]);
