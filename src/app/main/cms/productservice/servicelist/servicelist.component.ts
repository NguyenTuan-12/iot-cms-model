...
export class ServiceListComponent implements OnInit {
  ...
  getListData = (): void => {
    ...
    this._coreService.execute(this.state, "get-list-service", extraParams);
  };
  public dataStateChange(state: DataStateChangeEventArgs): void {
    ...
    this._coreService.execute(state, "get-list-service", extraParams);
  }
  ...
  clickToolbar = (itemButton: any): void => {
    ...
    switch (buttonId) {
      case ToolbarItem.ADD:
        this.router.navigate(["/cms/productservice/servicelist/new"]);
        break;
      default:
        break;
    }
  ...
  clickRecord = (data, status) => {
    if (data && status === 'view') {
      ...
      const paramAdd = window.btoa(JSON.stringify(objParamAdd));
      // window.open("/cms/productservice/servicelist/" + paramAdd, "_blank");
      this.router.navigate(["/cms/productservice/servicelist", paramAdd]);
